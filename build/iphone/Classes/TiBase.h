...
// in simulator we redefine to format for Twitter Developer console
...
{\
	NSString * exceptionName = [@"org.twitter." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.twitter";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UITwitterNativeItemNone = -1, 
	UITwitterNativeItemSpinner = -2,
	UITwitterNativeItemProgressBar = -3,
	
	UITwitterNativeItemSlider = -4,
	UITwitterNativeItemSwitch = -5,
	UITwitterNativeItemMultiButton = -6,
	UITwitterNativeItemSegmented = -7,
	
	UITwitterNativeItemTextView = -8,
	UITwitterNativeItemTextField = -9,
	UITwitterNativeItemSearchBar = -10,
	
	UITwitterNativeItemPicker = -11,
	UITwitterNativeItemDatePicker = -12,
	
	UITwitterNativeItemInfoLight = -13,
	UITwitterNativeItemInfoDark = -14,
	
	UITwitterNativeItemDisclosure = -15,
	
	UITwitterNativeItemContactAdd = -16
};
